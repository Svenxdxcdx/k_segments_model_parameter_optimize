...
# Helper methods
    ...
    def run_simulation(self, directory, training, test, monotonically_increasing = True, k = 4, collection_interval = 2):
        ...
        simulation = Simulation(self._simulations[self._currentModel + 1], directory, retry_mode = 'selective', provided_file_names = training)
        simulations.append(simulation)
...
if __name__ == "__main__":
    ...
    models.append(MostFrequentK_SL_k_segments(k = k, monotonically_increasing = monotonically_increasing))
    models.append(MostFrequentK_SL_k_segments(k = k, monotonically_increasing = monotonically_increasing))
    fileNames.append("MostFrequentK_SL_k_segments")
