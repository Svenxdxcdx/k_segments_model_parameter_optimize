...
class SameFileSizeSL_k_segments(KSegmentsModel):
    ...
    def buildLookUpTable(self, memoryList):
        ...
        for traingisSetLog in traingisSet:
            numberOfSegments = int(len(traingisSetLog) / segmentLength)
            numberOfAllSegments += numberOfSegments
            
        return int(numberOfAllSegments / len(traingisSet))
